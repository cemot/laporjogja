      ...
      <ul class="nav navbar-nav">
        ...
        <li>
          ...
          <ul class="dropdown-menu multi-level">
                ...
                <li><a href="<?php echo site_url("grafik_lap/grafik/4"); ?>">GRAFIK LAPORAN POLISI BENCANA ALAM</a></li>
                 ...
                 <li><a href="<?php echo site_url("grafik_penyidik/grafik/4"); ?>">GRAFIK PENYIDIK LAP. POLISI BENCANA ALAM</a></li>
