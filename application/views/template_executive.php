...
#myPleaseWait {
    ...
    <title>SISTEM PELAPORAN DAN PENYELIDIKAN POLDA DIY <?php echo $title; ?></title>
<!-- 
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" style="padding-left: 0px;">       
      <ul class="nav navbar-nav">
        <li class="active"><a href="<?php echo site_url("index_executive"); ?>">HOME</a></li>
        ...
        <li>
          ...
          <ul class="dropdown-menu multi-level">
            ...
            <li><a href="#">LAPORAN POLISI MODEL C</a></li>
            <li><a href="<?php echo site_url("ex_lap_d"); ?>">LAPORAN POLISI MODEL D</a></li>
            <li><a href="<?php echo site_url("ex_laka"); ?>">LAPORAN LAKA LANTAS</a></li>
           </ul>
        ...
        <li class="dropdown" ><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo strtoupper($userdata['jenis'])." $inst "." - ". $userdata['user_id']. " ". $userdata['nama'] ?> - EXECUTIVE <span class="caret"></span></a>
