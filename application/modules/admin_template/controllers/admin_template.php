...
class admin_template extends admin_controller {
	...
	function admin_template(){
		...
		$this->load->model("admin_template_model","dm");
	...
	function index(){
		...
		$this->set_subtitle("DATA TEMPLATE SURAT");
		$this->set_title("DATA TEMPLATE SURAT");
...
function simpan(){
		...
		$this->form_validation->set_rules('nama','Nama template','required'); 
		...
		if($this->form_validation->run() == TRUE ) { 
			...
			unset($data['id']);
			 ...
			 $res = $this->db->insert("template_dokumen",$data);
			 if($res) {
...
function update(){
		...
		if($this->form_validation->run() == TRUE ) { 
			 ...
			 $res = $this->db->update("template_dokumen",$data);
			 if($res) {
