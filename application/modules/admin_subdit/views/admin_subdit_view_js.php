...
function get_kesatuan(jenis,target){
		$.ajax({
			url : '<?php echo site_url("$this->controller/get_kesatuan") ?>/'+jenis,
...
BootstrapDialog.show({
            message : 'ANDA AKAN MENGHAPUS DATA SUBDIT/UNIT. ANDA YAKIN  ?  ',
            title: 'KONFIRMASI HAPUS DATA SUBDIT/UNIT',
            draggable: true,
            buttons : [
              {
                label : 'YA',
