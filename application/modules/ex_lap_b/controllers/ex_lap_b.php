<?php
class ex_lap_b extends super_controller {
// kesehatan,kekuatan, keturunan, masuk surga
	...
	function __construct(){
		...
		$this->load->model("ex_lap_b_model","dm");
		$this->load->model("admindik_lap_b_model","xm");
...
function detail($id){
	...
	$detail['rec_tersangka'] = $this->xm->get_tersangka($id);
    $detail['rec_saksi'] = $this->xm->get_saksi($id);
    ...
    $detail['rec_penyidik'] = $this->xm->get_data_penyidik(array("lap_b_id"=>$id)); 
