...
<head>
    ...
    <title>MONITORING PERKEMBANGAN KASUS </title>
         ...
         /* var iframe_height = parseInt($('html').height()); 
		  ...
		  $("#fm-login").submit(function(){
			  ...
			  vpass = $.md5($("#password").val());
		  	  $.ajax({
				url : '<?php echo site_url("monitor/ceklogin"); ?>',
				type : 'post',
				dataType : 'json',
				data : { mon_user: vuser, mon_pass : vpass },
...
<H4>MONITOR PERKEMBANGAN KASUS LAPORAN POLISI </H4>
