...
<tr class="separator"> <td colspan="2"> <b> DATA KENDARAAN</b>  </td> </tr>
...
<tr class="tr_ranmor">
  ...
  <td>
   ...
   <tr class="tr_ranmor">
  <td>Nomor Rangka </td> 
  <td>   <?php echo $kendaraan_no_rangka;  ?>
  ...
  <td>Nomor Mesin </td> 
  <td>
     <?php echo $kendaraan_no_mesin;  ?>
       
 </tr>
 
<tr class="tr_ranmor">
  <td>Pemilik </td>   <td>
     <?php echo $kendaraan_pemilik;  ?>
      
</tr>

<tr class="tr_ranmor">
  <td>Alamat </td>   <td>
     <?php echo $kendaraan_pemilik_alamat;  ?>
...
<tr class="tr_ranmor">
  <td>Merk </td>   <td>
     <?php echo $kendaraan_merk;  ?>
       
</tr>

<tr class="tr_ranmor">
  <td>Model </td>   <td>
     <?php echo $kendaraan_model;  ?>

</tr>
<tr class="tr_ranmor">
  <td>Warna </td>   <td>
     <?php echo $kendaraan_warna;  ?>
...
<tr class="tr_ranmor">
  <td>Jumlah Roda </td>   <td>
     <?php echo $kendaraan_jumlah_roda;  ?>
...
<tr class="tr_ranmor">
  <td>Tahun Buat  </td>   <td>
     <?php echo $kendaraan_tahun;  ?>
       
</tr>



      <tr class="separator"> <td colspan="2"> <b> DATA LAPORAN KEPOLISIAN</b>  </td> </tr>
